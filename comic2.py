...
Usage:
    python comic.py --input_dir path/to/input_images --output_dir path/to/output_panels [--japanese]
...
def process_image(image_path, output_dir, area_thresh_ratio=0.01, japanese=False):
    # Load the image
    ...
    # Sort bounding boxes based on reading order
    # For normal comics (left-to-right): sort top-to-bottom then left-to-right.
    # For Japanese manga style (right-to-left): sort top-to-bottom then right-to-left.
    if japanese:
...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default="input",
                        help="Path to the folder containing comic page images (default: 'input').")
    parser.add_argument("--output_dir", type=str, default="output",
                        help="Path to the folder where panel images will be saved (default: 'output').")
    ...
    parser.add_argument("--japanese", action="store_true", default=False,
                        help="If set, use Japanese manga reading order (right-to-left) instead of left-to-right.")
    ...
    for image_path in image_files:
        process_image(image_path, args.output_dir, args.area_thresh_ratio, japanese=args.japanese)
